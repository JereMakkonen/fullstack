...
const data: Diagnosis[] = [
  ...
  },
  {
    code: 'S03.5',
    name:
     'Sprin and strain of joints and ligaments of other and unspecified parts of head',
    latin:
  ...
  },
  {
    code: 'J10.1',
    name:
     'Infuenza with other respiratory manifestations, other influenza virus codeentified',
    latin:
